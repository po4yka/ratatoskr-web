    ...
    >
      {OPTIONS.map((option) => (
        <button
          ...
          className="min-h-7 rounded-md px-2 py-1 text-caption font-medium text-muted-foreground hover:text-foreground aria-[pressed=true]:bg-background aria-[pressed=true]:text-foreground"
        >
          {option.label}
        </button>
      ))}
