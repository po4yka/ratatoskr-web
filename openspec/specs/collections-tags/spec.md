# collections-tags Specification
...
capability names, the client SHALL use an injectable deterministic fixture seam
for collections and tags. It SHALL not issue an undeclared Edge API call or
claim that a server capability gate exists.
