# capture-operation-tracking Specification
...
capture kind, including each operation's state and an explained absence when no
capture operation exists. Local read and favorite controls SHALL change only
